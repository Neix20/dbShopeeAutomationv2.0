...
namespace dbShopeeAutomationV2.Controllers
{
    public class ProductionDetailFormController : AdminController
    {
        ...
        public ActionResult ProductionDetailFormGridViewPartialAddNew(TShopeeProductionDetail item)
        {
            ...
            dbStoredProcedure.productionDetailInsert(item.UOM, item.manufactured_date, item.expiry_date, item.quantity, (int) item.product_id, (int) item.production_id, username);
            db.SaveChanges();
